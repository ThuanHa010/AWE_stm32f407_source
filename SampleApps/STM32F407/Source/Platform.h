...
// Local attributes for Sensory module
typedef const unsigned short __nn_t;
typedef const unsigned short __gs_t;

extern __nn_t * g_pTrgNetLabel;
extern __gs_t * g_pTrgGrammarLabel;
extern __nn_t * g_pCmdNetLabel;
extern __gs_t * g_pCmdGrammarLabel;
