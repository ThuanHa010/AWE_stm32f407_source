...
//-----------------------------------------------------------------------------
// METHOD:  InitModules
// PURPOSE: Initialize any module global variables or assign local functions
//-----------------------------------------------------------------------------
void InitModules(void)
{
    // Trigger word net and search data
    //extern __nn_t dnn_netLabel[];
    //extern __gs_t dgs_grammarLabel[];

    // Local command net and search data
    //extern __nn_t nn_netLabel[];
    //extern __gs_t gs_grammarLabel[];

	// Init Sensory module data
    //g_pTrgNetLabel = (__nn_t *)dnn_netLabel;
    //g_pTrgGrammarLabel = (__gs_t *)dgs_grammarLabel;

    //g_pCmdNetLabel = (__nn_t *)nn_netLabel;
    //g_pCmdGrammarLabel = (__gs_t *)gs_grammarLabel;

	// Init User Function module
    //g_UserSelectFunction = UserSelectFunction;
...
void targetInit(void)
{
	...
	// Initialize any global pointers to data or local functions needed by AWE modules
	InitModules();
